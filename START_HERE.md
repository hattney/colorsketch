...
> **최종 갱신 2026-08-28.** 새 대화에서 이 폴더를 처음 열었다면 이 문서부터 끝까지 읽을 것.
...
| **C단계 나머지** | **결제 인프라: Turnstile·레이트리밋·캐시·워터마크·Blob·주문 상태·웹훅·다운로드** | ⬜ **다음 작업** |
...
| **`PHASE2_GUIDE.md`** | 서버리스·결제·주문 상태 머신 명세 (= C단계) | C단계 착수할 때 |
